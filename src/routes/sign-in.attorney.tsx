...
export const Route = createFileRoute("/sign-in/attorney")({
  validateSearch: searchSchema,
  head: () => ({ meta: [{ title: "Attorney sign in — VisaIQ" }] }),
  beforeLoad: async () => {
...
function AttorneySignInPage() {
  ...
  return (
    <LandingLayout shader={false} galaxy={true} className="p-0 m-0 w-full min-h-screen">
      <AuthUI search={search} portalLock="attorney" />
    </LandingLayout>
  );
}
